<?php
/**
 * Social Bump AI Knowledge Exporter
 * Version: 1.0.0
...
class SocialBump_AI_Knowledge_Exporter {
    ...
    private function get_generator_header(): array {
        return [
            'Generated by Social Bump AI Knowledge Exporter',
            ...
            if ( $this->get_serving_mode() === 'virtual' ) {
                ...
                if ( $shadowing ) {
                    ...
                    echo '<div class="notice notice-warning"><p>'
                        . '<strong>AI Knowledge Exporter:</strong> '
    ...
    public function render_admin_page(): void {
        ...
        <div class="wrap">
            ...
            <h1 style="margin-bottom:4px;">AI Knowledge Exporter</h1>
            ...
            <form id="sb-settings-form" data-sb-dirty method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                ...
                jQuery(function($) {
                    ...
                    $(window).on('beforeunload', function() {
                        if (isDirty) {
                            return 'You have unsaved changes to your AI Knowledge Exporter settings.';
                        }
                    });
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description" style="margin-top:10px;">
                                ...
                                <em>Changes here aren't saved until you click "Update Files" or "Full Rebuild". Refresh the page to discard.</em>
                            </p>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description" style="margin-top:10px;">
                                    <span class="sb-key">
                                        <span class="sb-key-item"><span class="sb-swatch sb-swatch--full"></span> Omitted from Full</span>
                                        <span class="sb-key-item"><span class="sb-swatch sb-swatch--details"></span> Omitted from Details</span>
                                    </span>
                                    <em>Changes here aren't saved until you click "Update Files" or "Full Rebuild". Refresh the page to discard.</em>
                                </p>
                                ...
                                (function () {
                                    ...
                                    function render() {
                                        ...
                                        rules.forEach(function (r, idx) {
                                            ...
                                            var label = document.createElement('span');
                                            label.textContent = (r.pt === '__all__' ? 'All' : ptLabel(r.pt)) + ' \u2192 ' + r.field + ' \u2192 ' + (isDetails ? 'Details' : 'Full');
                                            pill.appendChild(label);
    ...
    /**
     * Add the AI Knowledge Exporter menu to the WordPress admin bar.
     *
    ...
    public function add_admin_bar_button( $wp_admin_bar ): void {
        ...
        $wp_admin_bar->add_node( [
            ...
            'title' => $dot . 'AI Knowledge Exporter',
            'href'  => $settings_url,
            'meta'  => [
                'title' => $stale > 0
    ...
    public function render_post_meta_box( WP_Post $post ): void {
        ...
        if ( $is_excluded ) {
            ...
            echo '<p style="margin:6px 0;color:#646970;">'
                . '<span style="display:inline-block;width:9px;height:9px;border-radius:50%;background:#c3c4c7;margin-right:6px;"></span>'
                . 'This post is excluded from the export in the AI Knowledge Exporter settings.</p>';
            echo '</div>';
            return;
        }
    ...
    private function parse_field_omit_rules( $raw ): array {
        ...
        foreach ( $decoded as $rule ) {
            ...
            if ( $pt === '' || $field === '' || ! in_array( $file, [ 'full', 'details' ], true ) ) {
                continue;
            }
